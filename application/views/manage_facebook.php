<div id="content">
    <div id="manage_page">
        ...
        <div class="row">        
            <div class="col-sm-12">
                <?php echo form_open("Track/update_tcode/" . $tcode["id"] . "/?track_with=facebook"); ?>                
                    <table class="table table-bordered table-striped table-condensed">
                        <tr>
                            ...
                            <td class="fifth">
                                <label>Facebook Pixel Name:</label>
                                <input class="form-control" type="text" value="<?php echo $tcode['pixel_name'];?>" name="pixel_name">
                            </td>
                            <td class="fifth">
                                <label>Facebook Pixel ID:</label>
                                <input class="form-control" type="text" value="<?php echo $tcode['pixel_id'];?>" name="pixel_id">
                            </td>
