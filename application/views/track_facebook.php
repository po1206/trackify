        ...
        <div class="row-fluid">
            <div class="box">
                <div class="box-content">
                    <?php echo form_open("track/add_tcode/facebook"); ?>                
                        <table class="table table-bordered table-striped table-condensed">
                            <tr data-toggle="collapse" data-target="#accordion" class="clickable mobile">
                                ...
                                <th class="sixth">Facebook Pixel Name:</th>
                                <th class="sixth">Facebook Pixel ID:</th>
                            ...
                            <tr data-toggle="collapse" data-target="#accordion" class="clickable">
                                ...
                                <td class="sixth">                                    
                                    <span class="hide-desktop">Facebook Pixel Name:<br></span>
                                    <input class="form-control" type="text" name="pixel_name">
                                </td>
                                <td class="sixth">
                                    <span class="hide-desktop">Facebook Pixel ID:<br></span>
                                    <input class="form-control"  type="text" name="pixel_id">
                                </td>
                                <td  class="sixth">
                    ...
                    <table class="table table-striped table-condensed" id="fb_table">
                        ...
                        <tbody>                    
                            ...
                            <tr>
                                ...
                                <td><?php echo $row["pixel_name"];?></td>
                                <td><?php echo $row["pixel_id"];?><!-- - Fires: <?php echo $row["pixel_count"];?>--></td>
                                <td class="fb_action">
